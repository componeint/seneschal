...
/**
 * api.php
 * Created by anonymoussc on 11/19/2016 2:10 PM.
 */
...
$api->version('v1', ['namespace' => 'Componeint\Seneschal\Controllers'], function ($api) {
    ...
    $api->post('reactivate', [
        'as'   => 'seneschal.reactivate.send',
        'uses' => 'RegistrationController@resendActivation',
    ]);

    $api->get('forgot', [
        'as'   => 'seneschal.forgot.form',
        'uses' => 'RegistrationController@forgotPasswordForm',
    ]);

    $api->post('forgot', [
        'as'   => 'seneschal.reset.request',
        'uses' => 'RegistrationController@sendResetPasswordEmail',
    ]);
    ...
    */
    ...
    $api->post('reset/{hash}/{code}', [
        'as'   => 'seneschal.reset.password',
        'uses' => 'RegistrationController@resetPassword',
    ]);
    ...
    // Profile
    $api->get('profile', [
        'as'   => 'seneschal.profile.show',
        'uses' => 'ProfileController@show',
    ]);

    $api->get('profile/edit', [
        'as'   => 'seneschal.profile.edit',
        'uses' => 'ProfileController@edit',
    ]);

    $api->put('profile', [
        'as'   => 'seneschal.profile.update',
        'uses' => 'ProfileController@update',
    ]);

    $api->post('profile/password', [
        'as'   => 'seneschal.profile.password',
        'uses' => 'ProfileController@changePassword',
    ]);

    // Users
    $api->get('users', [
        'as'   => 'seneschal.users.index',
    ...
    $api->post('users', [
        'as'   => 'seneschal.users.store',
        'uses' => 'UserController@store',
    ]);

    $api->get('users/{id}', [
        'as'   => 'seneschal.users.show',
        'uses' => 'UserController@show',
    ]);

    $api->get('users/{id}/edit', [
        'as'   => 'seneschal.users.edit',
        'uses' => 'UserController@edit',
    ]);

    $api->post('users/{id}/password', [
        'as'   => 'seneschal.password.change',
        'uses' => 'UserController@changePassword',
    ]);

    $api->post('users/{id}/memberships', [
        'as'   => 'seneschal.users.memberships',
        'uses' => 'UserController@updateGroupMemberships',
    ]);

    $api->put('users/{id}', [
        'as'   => 'seneschal.users.update',
        'uses' => 'UserController@update',
    ]);

    $api->delete('users/{id}', [
        'as'   => 'seneschal.users.destroy',
        'uses' => 'UserController@destroy',
    ]);

    $api->get('users/{id}/suspend', [
        'as'   => 'seneschal.users.suspend',
        'uses' => 'UserController@suspend',
    ]);

    $api->get('users/{id}/unsuspend', [
        'as'   => 'seneschal.users.unsuspend',
        'uses' => 'UserController@unsuspend',
    ]);

    $api->get('users/{id}/ban', [
        'as'   => 'seneschal.users.ban',
        'uses' => 'UserController@ban',
    ]);

    $api->get('users/{id}/unban', [
        'as'   => 'seneschal.users.unban',
        'uses' => 'UserController@unban',
    ]);

    // Groups
    $api->get('groups', [
        'as'   => 'seneschal.groups.index',
    ...
    $api->post('groups', [
        'as'   => 'seneschal.groups.store',
        'uses' => 'GroupController@store',
    ]);

    $api->get('groups/{id}', [
        'as'   => 'seneschal.groups.show',
        'uses' => 'GroupController@show',
    ]);

    $api->get('groups/{id}/edit', [
        'as'   => 'seneschal.groups.edit',
        'uses' => 'GroupController@edit',
    ]);

    $api->put('groups/{id}', [
        'as'   => 'seneschal.groups.update',
        'uses' => 'GroupController@update',
    ]);

    $api->delete('groups/{id}', [
        'as'   => 'seneschal.groups.destroy',
