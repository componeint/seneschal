angular.module('jwtAuth').run(['gettextCatalog', function(gettextCatalog) {
    /* jshint -W100 */
    gettextCatalog.setStrings('es_AR', {
        'Actions'                : 'Acciones',
        'Add'                    : 'Agregar',
        'Add new record'         : 'Agregar un nuevo registro',
        'Check all rows'         : 'Seleccionar todas las filas',
        'Delete'                 : 'Eliminar',
        ...
        'to'                     : 'al',
        'Uncheck all rows'       : 'Quitar selección'
    });
    /* jshint +W100 */
}]);
